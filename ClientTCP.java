...
public class ClientTCP {
    ...
    public static void main(String[] args) {
        ...
        //Dichiarare una variabile di tipo Scanner per prendere gli input inseriti da tastiera dall'utente
        Scanner input = new Scanner(System.in);
        //Dichiarare una variabili per l'indirizzo IP del Server,per il numero di porta e per l'username dell'utente
        String IPServer;
        int NumeroPorta;
        String Username;
        ...
        IPServer = input.next();
        System.out.print("Inserie il numero di porta: ");
        NumeroPorta = input.nextInt();
        System.out.print("Inserire l'username: ");
        Username = input.next();
        ...
        try {
            ...
            System.out.println("Puoi iniziare a scrivere i tuoi messaggi: ");
